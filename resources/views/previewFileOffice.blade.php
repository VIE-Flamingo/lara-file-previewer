...
<script type="text/javascript" src="{{ asset('vendor/lara-file-previewer/officetohtml/PPTXjs/js/filereader.js') }}"></script>
<script type="text/javascript" src="{{ asset('vendor/lara-file-previewer/officetohtml/PPTXjs/js/d3.min.js') }}"></script>
<script type="text/javascript" src="{{ asset('vendor/lara-file-previewer/officetohtml/PPTXjs/js/nv.d3.min.js') }}"></script>
<script type="text/javascript" src="{{ asset('vendor/lara-file-previewer/officetohtml/PPTXjs/js/pptxjs.js') }}"></script>
<script type="text/javascript" src="{{ asset('vendor/lara-file-previewer/officetohtml/PPTXjs/js/divs2slides.js') }}"></script>

<!--All Spreadsheet -->
<link rel="stylesheet" href="{{ asset('vendor/lara-file-previewer/officetohtml/SheetJS/handsontable.full.min.css') }}">
<script type="text/javascript" src="{{ asset('vendor/lara-file-previewer/officetohtml/SheetJS/handsontable.full.min.js') }}"></script>
<script type="text/javascript" src="{{ asset('vendor/lara-file-previewer/officetohtml/SheetJS/xlsx.full.min.js') }}"></script>
<!--Image viewer--> 
<link rel="stylesheet" href="{{ asset('vendor/lara-file-previewer/officetohtml/verySimpleImageViewer/css/jquery.verySimpleImageViewer.css') }}">
<script type="text/javascript" src="{{ asset('vendor/lara-file-previewer/officetohtml/verySimpleImageViewer/js/jquery.verySimpleImageViewer.js') }}"></script>
<!--officeToHtml-->
...
<script>
   ...
   docxSetting: {
    ...
    pptxSetting: {
        ...
        revealjsPath: "{{ asset('vendor/lara-file-previewer/revealjs/') }}", /*path to js file of revealjs. default:  './revealjs/reveal.js'*/
